                ...
                <table className="w-auto text-sm text-left text-black">
                    <thead>
                        <tr className='items-center justify-center content-center'>
                            <th className="border border-black border-2 px-6 py-3 justify-center items-center">Task</th>
                            <th className="border border-black border-2 px-6 py-3 justify-center items-center">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
